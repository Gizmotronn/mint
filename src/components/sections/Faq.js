...
<Box> {/*Get advisory team to check off on these */}
  <Accordion ScrollTrigger={ScrollTrigger} title="I don't want to buy your product because I've heard bad things about NFTs" >
